...
class H2OXGBoostEstimator(H2OEstimator):
    ...
    def __init__(self, **kwargs):
        ...
        names_list = {"model_id", "training_frame", "validation_frame", "nfolds", "keep_cross_validation_predictions",
                      ...
                      "distribution", "tweedie_power", "quiet_mode", "ntrees", "max_depth", "min_rows",
                      ...
                      "max_delta_step", "score_tree_interval", "min_split_improvement", "max_bin", "num_leaves",
                      "min_sum_hessian_in_leaf", "min_data_in_leaf", "sample_type", "normalize_type", "rate_drop",
                      "one_drop", "skip_drop", "tree_method", "grow_policy", "booster", "gamma", "reg_lambda",
